...
const colD: SymbolDef[] = [
  ...
  { code: '1.1', name: 'Terrace', column: 'D',
    paths: ['M -40 -60 C -40 0, -40 0, -40 60', 'M 40 -60 C 40 -20, 0 0, 40 60'] },
  { code: '1.2', name: 'Spur', column: 'D',
    paths: ['M -40 -60 C -40 0, -40 0, -40 60', 'M 40 -60 C 40 -20, 0 10, 40 60'] },
  { code: '1.3', name: 'Reentrant', column: 'D',
  ...
  { code: '2.6', name: 'Boulder cluster', column: 'D',
    fills: ['M -30 -45 L 0 -10 L -60 -10 Z', 'M 30 45 L 60 10 L 0 10 Z'] },
  ...
  { code: '3.2', name: 'Pond', column: 'D',
    paths: ['M -60 20 C -20 -30, 20 -30, 60 20',
            'M -35 -25 C -23 -37, -12 -37, 0 -25 C 12 -13, 23 -13, 35 -25'] },
  { code: '3.3', name: 'Water hole', column: 'D',
    paths: ['M -50 55 L 0 -20 L 50 55',
            'M -30 -40 C -20 -50, 20 -50, 30 -40'] },
  { code: '3.4', name: 'River, stream', column: 'D',
    paths: ['M -55 60 C -30 30, -10 30, 0 0 C 10 -30, 30 -30, 55 -60'] },
  ...
  { code: '4.8', name: 'Copse', column: 'D',
    paths: ['M -30 40 L -10 -10 L 10 -10 L 30 40 Z', 'M -20 -10 L 0 -50 L 20 -10'],
    lines: [[-5, 40, -5, 55], [5, 40, 5, 55]] },
  { code: '4.9', name: 'Distinctive tree', column: 'D',
  ...
  { code: '5.5', name: 'Power line', column: 'D',
    lines: [[-55, 55, 55, -55], [-30, 20, -20, 40], [0, -10, 10, 10], [30, -40, 40, -20]] },
  { code: '5.6', name: 'Power line pylon', column: 'D',
    lines: [[-55, 55, 55, -55], [-30, 20, -20, 40], [30, -40, 40, -20]],
    circles: [[0, 0, 15]] },
...
const colE: SymbolDef[] = [
  ...
  { code: '8.4', name: 'Overgrown', column: 'E',
    lines: [[-55, -55, 55, 55], [-55, -18, 18, -55], [-55, 18, -18, 55],
            [55, -55, -55, 55], [18, -55, 55, -18], [-18, 55, 55, 18]] },
  { code: '8.5', name: 'Open', column: 'E',
    filledCircles: [
      [-45, -55, 5], [0, -55, 5], [45, -55, 5],
      [-55, -20, 5], [55, -20, 5],
      [-55, 20, 5], [55, 20, 5],
      [-45, 55, 5], [0, 55, 5], [45, 55, 5],
      [-55, -20, 5], [55, -20, 5],
  ...
  { code: '8.9', name: 'Needle-leaved', column: 'E',
    paths: ['M -30 10 L 0 -55 L 30 10 Z', 'M -15 50 L 0 15 L 15 50'],
    lines: [[0, 50, 0, 65]] },
  { code: '8.10', name: 'Broad-leaved', column: 'E',
    paths: ['M 0 -50 C 40 -40, 50 -10, 40 20 C 30 40, 10 50, 0 45 C -10 50, -30 40, -40 20 C -50 -10, -40 -40, 0 -50'],
    lines: [[0, 45, 0, 65]] },
...
const colF: SymbolDef[] = [
  ...
  { code: '11.7', name: 'Bend', column: 'F',
    paths: ['M -50 -50 C -20 -20, -10 10, 50 50'] },
]
...
const colH: SymbolDef[] = [
  ...
  { code: '12.2', name: 'Refreshment point', column: 'H',
    ...
    lines: [[-20, -55, 20, -55]] },
  { code: '12.4', name: 'Control check', column: 'H',
    paths: ['M -30 50 L 0 -10 L 30 50'],
    lines: [[0, -10, 0, -40]], filledCircles: [[0, -55, 10]] },
]
